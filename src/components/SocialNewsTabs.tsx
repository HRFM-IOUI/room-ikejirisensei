// src/components/SocialNewsTabs.tsx
"use client";
...
export default function SocialNewsTabs() {
  ...
  return (
    <section className="w-full py-10 bg-gradient-to-b from-white via-[#f6f7fa] to-[#edeffc] border-t border-primary/10 shadow-inner">
