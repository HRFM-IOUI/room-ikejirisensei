export default function Greeting() {
  return (
    <section className="w-full bg-white py-12 px-4 flex justify-center border-b border-primary/20">
      <div className="max-w-3xl w-full">
        {/* --- 見出し: 浮かび上がるブルーシャドウ&帯 --- */}
        <div className="mb-6">
          <h2
            className="
              text-3xl font-extrabold tracking-wide text-[#192349]
          ...
          >
            ご挨拶
            {/* 英語サブヘッダーやアイコンもここに重ねてOK */}
          </h2>
          {/* ブルー系グラデーションのアクセントライン */}
          <div className="h-1.5 w-16 mt-2 rounded-full bg-gradient-to-r from-blue-500 via-sky-400 to-blue-800 shadow-md" />
        </div>
        {/* --- 挨拶文 --- */}
        ...
        <p className="text-right text-gray-900 font-bold mt-8">
          つながる市民・練馬　代表／練馬区議会議員<br />
          <span className="text-2xl font-signature block text-primary mt-1">池尻成二</span>
        </p>
      </div>
    </section>
  );
