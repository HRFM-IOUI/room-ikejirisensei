    ...
    >
      <div className="max-w-3xl w-full">
        ...
        <div className="mb-4 sm:mb-6">
          ...
          <div className="h-1 w-10 sm:h-1.5 sm:w-16 mt-1.5 sm:mt-2 rounded-full bg-gradient-to-r from-blue-500 via-sky-400 to-blue-800 shadow-md" />
        </div>
        {/* --- 挨拶文 --- */}
        <div className="space-y-4 sm:space-y-5">
          <p className="text-sm sm:text-base text-gray-900 leading-relaxed sm:leading-relaxed">
            練馬区議会議員の池尻成二です。<br />
            ボトムアップで政治を変える。地域から、現場から、政治を市民の手に取り戻す。そんな思いで、区政と向き合っています。
            大切にしてきた合言葉、目指す政治の方向は、
            <span className="text-primary font-bold">“ともに生きる　ともにつくる”</span>。
          </p>
          <p className="text-sm sm:text-base text-gray-900 leading-relaxed sm:leading-relaxed">
        ...
        <p className="text-right text-gray-900 font-bold mt-8 text-sm sm:text-base">
