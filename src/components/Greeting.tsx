export default function Greeting() {
  return (
    <section className="w-full bg-white py-6 sm:py-12 px-2 sm:px-4 flex justify-center border-b border-primary/20 transition-all">
      <div className="w-full max-w-full sm:max-w-3xl">
        ...
        <div className="mb-4 sm:mb-6">
          ...
          {/* アクセントライン */}
          <div className="h-1 w-10 sm:w-16 mt-2 rounded-full bg-gradient-to-r from-blue-500 via-sky-400 to-blue-800 shadow-md" />
        </div>
        {/* 挨拶文 */}
        <p className="mb-2 sm:mb-4 text-sm sm:text-base text-gray-900 leading-relaxed">
          練馬区議会議員の池尻成二です。<br />
        ...
        <p className="text-right text-gray-900 font-bold mt-8 text-base sm:text-lg">
          つながる市民・練馬　代表／練馬区議会議員<br />
          <span className="text-xl sm:text-2xl font-signature block text-primary mt-1">池尻成二</span>
        </p>
      </div>
    </section>
  );
